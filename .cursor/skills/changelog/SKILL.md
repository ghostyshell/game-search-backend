...
name: changelog
description: >-
  Maintain CHANGELOG.md before commits in game-search-backend. Update [Unreleased]
  for internal/ or cmd/ changes, stage CHANGELOG with code. Use when committing, releasing,
